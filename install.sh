...
parted -s "$DISK" \
    ...
    set 1 esp on \
    mkpart mainroot 101MiB 100% \

ESP="/dev/disk/by-partlabel/ESP"
btrfsroot="/dev/disk/by-partlabel/main-root"
...
# cryptsetup luksFormat --type luks1 $btrfsroot
# echo "Opening the newly created LUKS Container."
# cryptsetup open $btrfsroot btrfsroot
BTRFS="/dev/mapper/mainroot"
...
mount -o noatime,space_cache,compress=zstd:2 $BTRFS /mnt
mkdir -p /mnt/{boot,root,home,.snapshots,srv,tmp,/var/log,/var/log/journal,/var/crash,/var/cache,/var/tmp,/var/spool,/var/lib/libvirt/images,/var/lib/machines,/var/lib/sddm,/var/lib/AccountsService}
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodev,nosuid,noexec,subvol=@/boot $BTRFS /mnt/boot
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodev,nosuid,subvol=@/root $BTRFS /mnt/root 
mount -o noatime,space_cache=v2.autodefrag,compress=zstd:2,discard=async,nodev,nosuid,subvol=@/home $BTRFS /mnt/home
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,subvol=@/.snapshots $BTRFS /mnt/.snapshots
mount -o noatime,space_cache=v2.autodefrag,compress=zstd:2,discard=async,subvol=@/srv $BTRFS /mnt/srv
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_log $BTRFS /mnt/var/log
...
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,subvol=@/var_log_journal $BTRFS /mnt/var/log/journal

mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_crash $BTRFS /mnt/var/crash
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_cache $BTRFS /mnt/var/cache
...
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,subvol=@/var_tmp $BTRFS /mnt/var/tmp

mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_spool $BTRFS /mnt/var/spool
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_lib_libvirt_images $BTRFS /mnt/var/lib/libvirt/images
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_lib_machines $BTRFS /mnt/var/lib/machines
...
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_lib_sddm $BTRFS /mnt/var/lib/sddm
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@/var_lib_AccountsService $BTRFS /mnt/var/lib/AccountsService

# The encryption is splitted as we do not want to include it in the backup with snap-pac.
mount -o noatime,space_cache=v2,autodefrag,compress=zstd:2,discard=async,nodatacow,nodev,nosuid,noexec,subvol=@$BTRFS /mnt
...
#chmod 000 /mnt &>/dev/null
#cryptsetup -v luksAddKey /dev/disk/by-partlabel/btrfsroot /mnt/cryptkey/.root.key
sed -i "s#quiet# root=$BTRFS lsm=landlock,lockdown,yama,apparmor,bpf #g" /mnt/etc/default/grub
